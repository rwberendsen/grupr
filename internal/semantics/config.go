...
func GetConfig() *Config {
	...
	cnf.ValidUnquotedExpr = regexp.MustCompile(`^[a-z_][a-z0-9_$]{0,254}[*]?$`) // identifier chars + optional wildcard suffix
	cnf.ValidQuotedExpr = regexp.MustCompile(`.{0,255}`)
	...
	cnf.UserGroupTemplate = "[user_group]"
